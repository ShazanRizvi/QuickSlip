  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-blue-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border dark:bg-transparent border-blue-600 dark:border-blue-600 shadow-sm hover:bg-blue-600 hover:text-white dark:text-blue-600",
        secondary:
          "bg-blue-100 text-blue-900 shadow-sm hover:bg-blue-100/80 dark:bg-blue-800 dark:text-white dark:hover:bg-blue-800/80",
