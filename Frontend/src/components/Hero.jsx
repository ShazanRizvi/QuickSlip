        ...
        <div className="grid max-w-screen-xl px-0 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
              Welcome to Quickslip
            </h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              The fastest invoice generation tool to help you create
              professional invoices in minutes
            </p>
            <div className="flex gap-4">
              <NavLink to="/InvoiceGenerator/signup">
                <Button className="text-lg p-6 rounded-md">
                  Get Started{" "}
                  <svg
              ...
              <NavLink to="/InvoiceGenerator/login">
                <Button variant='secondary' className="text-lg p-6 rounded-md">
                  Login{" "}
                 <RiLoginCircleLine className="w-5 h-5 ml-2 -mr-1"/>
                </Button>
              </NavLink>
            </div>
          </div>
